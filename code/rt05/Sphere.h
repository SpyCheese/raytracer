...
// Sphere - объект, сфера
// Задаётся центром и радиусом, а также цветом
...
struct Sphere : Object {
	...
	Sphere(Vector3 const & p, double r, Color const & c) :
	...
	virtual Color getColor(Vector3 const & pos, Vector3 const & dir) {
		return color * getLight(pos, getGoodNormal(normalize(pos - center), dir));
	}
};
