...
// handleHightRay - вызывается во врем трассировки световых лучей~--- это тот свет, который попадает на объект
...
struct Object {
	...
	virtual void handleLightRay(Vector3 const & pos, Vector3 const & dir, Color const& col) = 0;
	virtual ~Object() {}
};
